...
def main():
    ...
    try:
        optimal_strategy, total_time_optimal = optimize_charging_strategy(charging_stations, vehicle_params, vehicle_params['charging_curve'])
    except ValueError as e:
    ...
    try:
        traditional_strategy_result, total_time_traditional = traditional_strategy(charging_stations, vehicle_params, vehicle_params['charging_curve'])
    except ValueError as e:
